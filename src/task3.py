...
def main():
    ...
    input_file = "/workspaces/spark-structured-api-employee-engagement-analysis-polamsrija1/input/employee_data.csv"
    output_file = "/workspaces/spark-structured-api-employee-engagement-analysis-polamsrija1/outputs/task3/engagement_levels_job_titles.csv"
